...
void initTimedTasks(void)
{
    ...
    // FTM3_C0SC |= FTM_CSC_CHIE; //| FTM_CSC_MSA | FTM_CSC_ELSB ; // enable Interrupt for channel 1
...
void ftm3_isr(void)
{
    if (FTM3_C0SC & FTM_CSC_CHF) { FTM3_C0SC &= ~FTM_CSC_CHF; task0(); }
   // if (FTM3_C1SC & FTM_CSC_CHF) { FTM3_C1SC &= ~FTM_CSC_CHF; } task1();
