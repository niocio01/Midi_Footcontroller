...
#define BTN_BK_UP_PIN       2
#define BTN_BK_DWN_PIN      3
#define BTN_MODE_PIN        4
#define BTN_SAVE_PIN        5
#define BTN_BACK_PIN        6
#define BTN_SELECT_PIN      7

#define BTN_BK_UP_CONFIG    CORE_PIN2_CONFIG
#define BTN_BK_DWN_CONFIG   CORE_PIN3_CONFIG
#define BTN_MODE_CONFIG     CORE_PIN3_CONFIG
#define BTN_SAVE_CONFIG     CORE_PIN3_CONFIG
#define BTN_BACK_CONFIG     CORE_PIN6_CONFIG
#define BTN_SELECT_CONFIG   CORE_PIN3_CONFIG

#define BTN_BK_UP_PINMASK   CORE_PIN2_PINREG & CORE_PIN2_BITMASK
#define BTN_BK_DWN_PINMASK  CORE_PIN3_PINREG & CORE_PIN3_BITMASK
#define BTN_MODE_PINMASK    CORE_PIN4_PINREG & CORE_PIN4_BITMASK
#define BTN_SAVE_PINMASK    CORE_PIN5_PINREG & CORE_PIN5_BITMASK
#define BTN_BACK_PINMASK    CORE_PIN6_PINREG & CORE_PIN6_BITMASK
