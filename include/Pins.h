...
#define TRACK5_PLAY_PIN     14 // 13 is used for LED
...
#define TRACK5_PLAY_CONFIG   CORE_PIN14_CONFIG
...
#define TRACK5_PLAY_PINMASK  CORE_PIN14_PINREG & CORE_PIN14_BITMASK
